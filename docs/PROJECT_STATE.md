...
VERIFIED: exported max joint speed 2.3464 rad/s (<=2.349 budget); reachable 540/729 (74.07%);
...
PHYSICS PROOF (Phase D): MuJoCo physics replay executed (8 grasp windows, max lift 0.0059m, mean tracking err 0.2718 rad).
...
- Physics Replay Proof: Phase D blocked on replay-harness calibration (controller tracking + object placement); perception upgrade queued pending isolation.
